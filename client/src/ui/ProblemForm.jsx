	...
	return (
		...
		>
			<div className='flex flex-col w-full justify-center px-10'>
				...
				>
					Изображение
					<p className='text-sm text-white/50 uppercase'>max. 10Mb</p>
				</label>
				<input
					className='rounded-lg text-white text-lg font-semibold outline-none placeholder: placeholder:font-extralight'
					type='file'
					name='beforeImg'
					onChange={e => {
						setErr('')
